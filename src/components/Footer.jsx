    ...
    <footer className="footer-section" id="contact">
      ...
      <div className="footer-main">
        ...
        <div className="footer-brand">
          ...
          <p>
            Yenilikçi, şeffaf ve çevre dostu yaklaşımımızla küresel tedarik zincirinin en güçlü ve güvenilir halkalarından biri olmaya devam ediyoruz.
          </p>
        ...
        <div className="footer-col">
          ...
          <div className="footer-links">
            ...
            <a href="#">Mürettebat Sağlama</a>
            <a href="#">Liman Acenteliği</a>
        ...
        <div className="footer-contact">
          ...
          <p>
            ...
            <span>info@auroramaritime.com</span>
          </p>
          <p>
      ...
      <div className="footer-bottom">
        <div className="copyright">
          &copy; {new Date().getFullYear()} Aurora Maritime Corp. Tüm hakları saklıdır.
        </div>
